...
<div class="mt-10 mb-10 p-4">
    ...
    <a href="{{route('tv.show', [$tvshow['id']])}}"><button
            ...
            < Back to Episodes</button> </a> </div> <video class="h-full w-full mr-8 p-2" src="{{$streamurl}}" controls>
                </video>
                                ...
                                <div class="flex py-3 text-sm mt-4">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="{{route('tv.episode',[$id,$season['season_number'], $episode] )}}?hash=dl&dlink={{urlencode($torrent['url'])}}">
                                                <div
